<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Checkout.aspx.cs" Inherits="SarthakGupta_BookStore.Checkout" %>
...
<!-- Giving Reference from Site.MasterPage. -->
    ...
    <div class="container-products mt-5 ">
        ...
        <div class="btn-group-custom">
            <asp:Button ID="CheckOutButton" OnClientClick="return validateForm();" OnClick="CheckOutButton_Click" runat="server" Text="Check Out" CssClass="success-btn mr-2" />
